...
<div class="row row-cols-1 row-cols-md-2 g-4">
  ...
  <div class="col">
    <div class="card h-100 shadow-sm">
      ...
      <div class="card-body">
        <h5 class="card-title">Research and Development of a High-Power, High-Energy Battery System (250 Wh/kg-Class) for Electric Aviatior </h5>
  ...
  <div class="col">
    <div class="card h-100 shadow-sm">
      <img src="{{ site.baseurl }}/assets/kuam/30.jpg" class="card-img-top" alt="K-UAM Safety Tech" style="height: 400px; object-fit: cover;">
      <div class="card-body">
